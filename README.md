...
![Oblique dorsal](screenshots/screenshot-1.png)
_Oblique dorsal_

![Oblique ventral](screenshots/screenshot-2.png)
_Oblique ventral_

![Without matrix](screenshots/screenshot-3.png)
_Without matrix_

## About the specimen
Skull of _Herpetotherium fugax_ (formerly _Peratherium sp._) from AMNH fossil mammal collections (AMNH-FM-22304). Collected from Chadronian/Orellan; 2.5 mi SE of Jim Christian Hills, Lusk area, Niabrara Co., WY by Morris Skinner & Bob Emry (1960).
...
Images are reoriented in 3D Slicer to conform anatomical directions and resampled for 0.018 micron isotropic resolution by Murat Maga.
